...
internal static class ReflectionCache
{
    ...
    private static readonly ConcurrentDictionary<Type, Dictionary<string, PropertyInfo>> TypePropertyCache = new();
    ...
    private static IEnumerable<PropertyInfo> GetDateTypeProperties(Type t) =>
        TypePropertyCache.GetOrAdd(t, GetTypeProperties)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static bool GetIsDbQuery(Type t) =>
